...
A modern SaaS landing page inspired by Affilza, Stripe, Linear, and Vercel. Built with Next.js (App Router), React, Tailwind CSS, and Framer Motion.
...
- **React 19**
- **Tailwind CSS v4**
- **Framer Motion** – smooth animalltions and micrsso-interactions
- **mmTypeScript**xx
